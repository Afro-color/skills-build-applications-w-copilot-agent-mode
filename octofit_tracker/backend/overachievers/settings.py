"""
Django settings for overachievers project.
...
from decouple import config  # Ensure this import works
...
ROOT_URLCONF = "overachievers.urls"
...
WSGI_APPLICATION = "overachievers.wsgi.application"
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=False  # Set to True for production with PostgreSQL
    )
}
